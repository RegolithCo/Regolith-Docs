...
You may have noticed that [Regolith.rocks](https://regolith.rocks) is a little simpler these days. As of this moment I've made the decision to remove any AI-generated images from the site and commit to this policy going forward. The "art" in question was mainly the sci-fi background images you used to see behind every section of the website. 

### *"Ok, but why? And why now?"*

Let's start with the fact that I'm basically Benny the spaceman from the Lego Movie. As a kid if you placed me in a chair with crayons and a diner placemat or concert program what you'd get in return is A) hours of silence any parent would envy and B) an unending, bottomless cascade of pictures of spaceships.
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/LhG8Ry-L3IQ?si=3IUnwMyDdzcz_E1C" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
 ...
 The word "obsession" almost feels quaint. Then again if you play Star Citizen then you probably relate. In my mind I was [Ralph McQuarrie](https://en.wikipedia.org/wiki/Ralph_McQuarrie) and my drawings were wild escapades, the embodiment of a well-fed imagination. Even today, when I see sci-fi concept art, that inner child wakes up with a squeal of joy and does a little chicken dance in my brain. 
 
 When Midjourney AI launched, I suddenly found I could type my thoughts into a box and get back "art" that looked to me like a [Syd Mead's](https://en.wikipedia.org/wiki/Syd_Mead) original. I didn't ask questions; I just started creating. This thing was manifesting my imagination and the allure of that immediately silenced every other voice.
...
I mean, YEAH RIGHT?!?! YEAH!!! Talk about understanding the assignment. That's a freaking ARGO Mole with Regolith branding on the ground. This wasn't slop; not exactly. I wouldn't have hired an artist to do this. This was just me having fun right? RIGHT?!? I gleefully posted the new pics on [Bluesky](https://bsky.app/) and went to bed.
...
It didn't have to be this way. It could have been trained solely on public domain art. They could have compensated artists for their work. They could have had an opt-in system. Could. Could. Could. Didn't.
...
### 3. AI is Built, Controlled and Funded by Bad People.
...
It turns out that AI is basically an environmental catastrophe. The datacenters that power it are using the energy and water supplies of small cities. 

While it is possible that AI technically has the potential to solve fusion, the AI that will do that is not the same AI that makes [Will Smith eat spaghetti](https://www.youtube.com/watch?v=vbWe5k4fFWE). ChatGPT will never wake up and make a Tokamak reactor work. The AI that *might* eventually do this will be hyper-specialized, written by scientists and have exactly 0% chance of calling itself "mecha-hitler".

Also, predictably, the [environmental impacts](https://news.mit.edu/2025/explained-generative-ai-environmental-impact-0117) of all of this impact vulnerable people first in the form of increased energy prices, water availability and quality problems, decimation of small communities, noise pollution etc.  
